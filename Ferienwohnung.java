/**
  ...
  * Klasse: FS 63
  * 
  * Author: Nico Fischer, Lukas Wüstenhagen, Daniel Schönke, Jony Nchamadi
  * AS-Projekt
...
public class Ferienwohnung {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("____________________Managementsystem für Ferienwohnungen________________________");
    do{
      //Modul_Update('g',......);
      System.out.println("\n1 - Übersicht der Ferienwohnungen");
      ...
      System.out.print("\nBitte geben sie ein Menüpunkt an, um fortzufahren : ");
      wahl = Tastatur.liesInt();
      
      switch (wahl) {
        case  1: 
        System.out.println( "1 - Ausgabe einer bzw aller Auslastung(en) der Ferienwohnung(en)  "); // -> Modul Übersicht
